...
import { BarChart3, Gem, Medal, Users } from "lucide-react";
...
// Lineup page — all cards now render below the lineup grid.
// Polish spec §109 (Phase 36). Shop was absorbed into /lineup
// too — buy-packs modal opens from a floating action button.
const NAV = [
