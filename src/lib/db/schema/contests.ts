...
export const contest = pgTable(
  "contest",
  {
    ...
    entryFeeCoins: bigint("entry_fee_coins", { mode: "bigint" }).notNull().default(sql`0`),
...
export const contestEntry = pgTable(
  "contest_entry",
  {
    ...
    entryCoinCost: bigint("entry_coin_cost", { mode: "bigint" }).notNull().default(sql`0`),
    ...
    coinPayout: bigint("coin_payout", { mode: "bigint" }).notNull().default(sql`0`),
