...
export const managerAccount = pgTable(
  "manager_account",
  {
    ...
    managerXp: bigint("manager_xp", { mode: "bigint" }).notNull().default(sql`0`),
    lifetimeFp: bigint("lifetime_fp", { mode: "bigint" }).notNull().default(sql`0`),
...
export const userSeasonState = pgTable(
  "user_season_state",
  {
    ...
    seasonFp: bigint("season_fp", { mode: "bigint" }).notNull().default(sql`0`),
